            ...
            VStack {
                if isEditing {
                    ...
                    TextField("Notiz Titel", text: $notizenTitle)
                        .font(.headline)
                        .padding()
                        .onChange(of: notizenTitle) { oldTitle, newTitle in
                            ...
                            if !newTitle.isEmpty && !existingTitles.contains(newTitle) {
                                ...
                                notizenTitle = existingTitles.contains(newTitle) ? "" : oldTitle
                            }
                        }
                }
                    ...
                    TextField("Einkaufslistenname bearbeiten", text: $notizenTitle)
                        ...
                        .onChange(of: notizenTitle) { oldValue, newValue in
                            ...
                            if !newValue.isEmpty && !existingTitles.contains(newValue) {
                                ...
                                notizenTitle = existingTitles.contains(newValue) ? oldValue : ""
                            }
                        }
                }
